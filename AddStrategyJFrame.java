 ...
 * @author lyx
 */
public class AddStrategyJFrame extends javax.swing.JFrame {
     ...
     */
    public AddStrategyJFrame(MainJFrame parent) {
        initComponents();
...
//              char ch = (char) b;
    ...
    private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOKActionPerformed
        ...
        jComboBoxStrategy.addItem(jTextFieldStrategyName.getText());
        strategyMap.put(jTextFieldStrategyName.getText(), jTextAreaStrategy.getText());
        if (jComboBoxStrategy.getItemCount() == 1) {
            parent.getjTextAreaLookStrategyArea().setText(jTextAreaStrategy.getText());
            parent.getjButtonEditStrategy().setEnabled(true);
            parent.getjButtonDeteleStrategy().setEnabled(true);
        } else if (jComboBoxStrategy.getItemCount() > 1) {
            parent.getjButtonStartWar().setEnabled(true);
        }
    ...
    private void jButtonSaveFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveFileActionPerformed
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                Logger.getLogger(AddStrategyJFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//            System.out.println(source);
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter(System.getProperty("user.dir")
                    + "/Strategy" + parent.getjComboBoxStrategy().getItemCount() + ".java"));
            source = source.replace("Strategy", "Strategy" + parent.getjComboBoxStrategy().getItemCount());
		...
		complier = c.newInstance();
            ...
            Iterable it = sjf.getJavaFileObjects(System.getProperty("user.dir")
                    + "/Strategy" + parent.getjComboBoxStrategy().getItemCount()
                    + ".java");
            ...
            Class c = uLoad.loadClass("Strategy" + parent.getjComboBoxStrategy().getItemCount()); // 找哪个class文件 注意不带后缀名
            parent.getClassList().add(c.newInstance());

            File tmpFile = new File(System.getProperty("user.dir") + "/Strategy" + parent.getjComboBoxStrategy().getItemCount() + ".java");
            tmpFile.delete();
            tmpFile = new File(System.getProperty("user.dir") + "/Strategy" + parent.getjComboBoxStrategy().getItemCount() + ".class");
            tmpFile.delete();
        } catch (Exception ex) {
            Logger.getLogger(AddStrategyJFrame.class.getName()).log(Level.SEVERE, null, ex);
            return false;
